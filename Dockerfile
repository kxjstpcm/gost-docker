...
CMD nohup sing-box-${SBVER}-linux-amd64/sing-box run -c sing-box-${SBVER}-linux-amd64/config.json & ./gost-linux-amd64-${VER} -L=relay+ws://:10000?path=/$PASSWORD -F=socks5://127.0.0.1:12345
